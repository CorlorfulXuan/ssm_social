...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/admin_photoList.jsp"><span class="glyphicon glyphicon-picture"></span> 照片管理</a></li>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table data-toggle="table" data-locale="zh-CN" data-url="${pageContext.request.contextPath}/admin/photo-list" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"
                           data-search="true" data-select-item-name="id" data-pagination="true" data-sort-name="id">
                        <thead>
                        <tr>
                            <th data-field="id" data-sortable="true">ID</th>
                            <th data-field="l_id"  data-sortable="true">Connection</th>
                            <th data-field="address" data-formatter="showImg">photo</th>
...
<script>
    ...
    function showImg(value) {
        var html = "<img src=\'${pageContext.request.contextPath}/photos/"+value+"\' width=\'100\' height=\'100\'/>";
        return html
    }
    ...
    $("#deleteIds").click(function() {
        ...
        $.ajax({
            cache: false,
            url: "${pageContext.request.contextPath}/admin/delPhoto", //url
            type: "DELETE",  //方法类型
