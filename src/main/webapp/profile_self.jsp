...
<nav class="navbar navbar-expand navbar-dark bg-dark osahan-nav-top p-0">
    <div class="container">
        <a class="navbar-brand mr-2" href="${pageContext.request.contextPath}/index.jsp">
            <img src="${pageContext.request.contextPath}/img/lsocial.png" alt="">
        </a>
            ...
            <main class="col">
                <div class="box mb-3 shadow-sm border rounded bg-white profile-box text-center">
                    ...
                    <div class="overflow-hidden border-top">
                        <a class="font-weight-bold p-3 d-block" href="${pageContext.request.contextPath}/user/edit"> Edit </a>
                    </div>
                </div>
                    ...
                    <div class="box mb-3 shadow-sm border rounded bg-white osahan-post">
                        ...
                        <div class="p-3">
                            <form class="d-flex" action="${pageContext.request.contextPath}/comment/add-comment" method="post">
                                ...
                                <button type="button" onclick="delMoment(${moment.id})" class="btn btn-outline-primary pl-4 pr-4">delete</button>
                            </form>
                        </div>
                    </div>
                </c:forEach>
...
<script>
    function delMoment(mid) {
        if (confirm("确认删除这条动态吗？")) {
            location.href="${pageContext.request.contextPath}/moment/delMoment/"+mid+"/"+${pageInfo.pageNum};
        }
    }
</script>
</body>
