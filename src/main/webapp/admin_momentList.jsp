...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/admin_momentList.jsp"><span class="glyphicon glyphicon-envelope"></span> 动态管理</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">动态列表</div>
                <div class="panel-body">
                    <table data-toggle="table" data-locale="zh-CN" data-url="${pageContext.request.contextPath}/admin/moment-list" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"
...
<script>
    ...
    $("#deleteIds").click(function() {
        ...
        $.ajax({
            cache: false,
            url: "${pageContext.request.contextPath}/admin/delMoment", //url
            type: "DELETE",  //方法类型
