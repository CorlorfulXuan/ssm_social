...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <li class="active"><a href="${pageContext.request.contextPath}/admin_userList.jsp"><span class="glyphicon glyphicon-user"></span> 用户管理</a></li>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table data-toggle="table" data-locale="zh-CN" data-url="${pageContext.request.contextPath}/admin/user-list" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"
                        ...
                        <tr>
                            ...
                            <th data-field="born" data-sortable="true">Born</th>
                            <th data-field="sex" data-sortable="true">Sex</th>
                            <th data-field="avatar" data-formatter="showImg">Avatar</th>
...
<script>
    ...
    function showImg(value) {
        var html = "<img src=\'${pageContext.request.contextPath}/photos/"+value+"\' width=\'50\' height=\'50\'/>";
        return html
    }
    ...
    $("#deleteIds").click(function() {
        ...
        $.ajax({
            cache: false,
            url: "${pageContext.request.contextPath}/admin/delUser", //url
            type: "DELETE",  //方法类型
