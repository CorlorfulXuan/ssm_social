...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/admin_eventList.jsp"><span class="glyphicon glyphicon-time"></span> 事件管理</a></li>
    </ul>
</div><!--/.sidebar-->
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">纪念日列表</div>
                <div class="panel-body">
                    <table data-toggle="table" data-locale="zh-CN" data-url="${pageContext.request.contextPath}/admin/event-list" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"
                        ...
                        <tr>
                            ...
                            <th data-field="thing"  data-sortable="true">Thing</th>
...
<script>
    ...
    $("#deleteIds").click(function() {
        ...
        $.ajax({
            cache: false,
            url: "${pageContext.request.contextPath}/admin/delEvent", //url
            type: "DELETE",  //方法类型
