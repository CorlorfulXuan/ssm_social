...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/admin_dairyList.jsp"><span class="glyphicon glyphicon-text-width"></span> 日记管理</a></li>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table data-toggle="table" data-locale="zh-CN" data-url="${pageContext.request.contextPath}/admin/dairy-list" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"
                        ...
                        <tr>
                            ...
                            <th data-field="uid"  data-sortable="true">User</th>
                            <th data-field="weather" data-sortable="true">Weather</th>
...
<script>
    ...
    $("#deleteIds").click(function() {
        ...
        $.ajax({
            cache: false,
            url: "${pageContext.request.contextPath}/admin/delDairy", //url
            type: "DELETE",  //方法类型
