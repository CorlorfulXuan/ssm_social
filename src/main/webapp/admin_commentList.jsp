...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/admin_commentList.jsp"><span class="glyphicon glyphicon-comment"></span> 评论管理</a></li>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table data-toggle="table" data-locale="zh-CN" data-url="${pageContext.request.contextPath}/admin/comment-list" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"
                           data-search="true" data-select-item-name="id" data-pagination="true" data-sort-name="id">
                        <thead>
                        <tr>
                            <th data-field="id" data-sortable="true">ID</th>
                            <th data-field="mid"  data-sortable="true">mid</th>
...
<script>
    ...
    $("#deleteIds").click(function() {
        ...
        $.ajax({
            cache: false,
            url: "${pageContext.request.contextPath}/admin/delComment", //url
            type: "DELETE",  //方法类型
